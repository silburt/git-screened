...
app.layout = html.Div([html.Div([
                                 ...
                                 dcc.Markdown(dedent('''
                                    ...
                                    **Instructions**: Enter a github repository in the search box below and click "search". A list of metrics summarizing the github repository will be output, along with a pass/fail classification (generated from a pre-trained One-Class SVM model) for the overall production-level quality of the repository. Histograms can also be output that contextualize the searched repository to the "industry standard", where "industry standard" is the top 5000 starred Python repositories on Github. Not that the histograms are all dislpayed on a log scale. Lastly, a festive meme can also be output ;).
